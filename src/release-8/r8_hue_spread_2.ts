...
const radius = 80
const dotRadius = 10
const dotColor = new paper.Color('white')
...
export const r8HueSpread2 = (
  ...
  if (n === 0) {
     ...
     * -> 1
     */
    const dotGroup = drawDots([origin], dotColor, dotRadius)
    positionGroup.addChild(dotGroup)

    {
      // zero-point group
      const childDotGroup = drawDots(points, dotColor, dotRadius)
      const goal = radius * 2
      ...
      // const outlineDots = drawDots([outlinePoint], dotColor, dotRadius * 0.75)
